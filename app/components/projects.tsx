...
export default function Projects() {
    ...
    return (
        <div className="projects flex w-full overflow-hidden px-14 py-20 bg-gradient-to-br from-neutral-800 via-neutral-900 to-neutral-950">
            <div className="container mx-auto">
                ...
                >
                    <h2 className="lora mb-8 text-3xl font-bold leading-none tracking-tight text-neutral-100 md:text-4xl text-center">My Projects</h2>
                    <p className="courier-prime-regular text-zinc-300 text-center max-w-2xl mx-auto mb-12">
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            <div className="project-image-container">
                                ...
                                <div className="project-overlay">
                                    <div className="project-links">
                                        ...
                                        {project.githubUrl && <a href={project.githubUrl} className="project-link" target="_blank" rel="noopener noreferrer">
                                            GitHub
                                        </a>}
                                    </div>
                                </div>
                            ...
                            <div className="project-content">
                                <h3 className="lora text-xl font-semibold text-neutral-200 mb-2">{project.title}</h3>
